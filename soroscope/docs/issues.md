...
A practical framework for maintainers to write issues that attract the right contributors, reduce back-and-forth, and lead to better outcomes.
...
- Too big equals overwhelming.
- Too small equals pointless.
...
**Suggested execution:**
1. Fork the repo and create a branch: `git checkout -b feature/claim-burn`
2. Implement changes:
...
**Example commit message:** `feat: add claim/burn UI and wallet states`
...
**Suggested execution:**
1. Fork the repo and create a branch: `git checkout -b feature/token-vesting`
2. Implement changes:
...
**Example commit message:** `feat: implement token vesting with tests and docs`
...
If anything is unclear, you can always reach out to the team for clarification or check the docs.
