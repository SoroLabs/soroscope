...
impl TokenTrait for Token {
    ...
    fn mint(e: Env, to: Address, amount: i128) {
        ...
        e.events().publish((soroban_sdk::Symbol::new(&e, "mint"), admin, to), amount);
    }
    ...
    fn set_admin(e: Env, new_admin: Address) {
        ...
        EmergencyGuard::remove_admin(e.clone(), vec![&e, admin.clone()], admin.clone())
            .expect("failed to remove old token admin");
        write_administrator(&e, &new_admin);
        e.events().publish((soroban_sdk::Symbol::new(&e, "set_admin"), admin, new_admin), ());
    }
    ...
    fn approve(e: Env, from: Address, spender: Address, amount: i128, expiration_ledger: u32) {
        ...
        e.events().publish((soroban_sdk::Symbol::new(&e, "approve"), from, spender), amount);
    }
    ...
    fn transfer(e: Env, from: Address, to: Address, amount: i128) {
        ...
        receive_balance(&e, to.clone(), amount);
        e.events().publish((soroban_sdk::Symbol::new(&e, "transfer"), from, to), amount);
    }
    ...
    fn burn(e: Env, from: Address, amount: i128) {
        ...
        e.events().publish((soroban_sdk::Symbol::new(&e, "burn"), from), amount);
    }
