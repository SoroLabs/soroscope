...
fn test_bitwise_storage_benchmark() {
    ...
    println!(
        "Separate storage slots: CPU = {} instructions, Memory = {} bytes",
        sep_write_cpu, sep_write_mem
    );
    println!(
        "Packed (bitwise) slot : CPU = {} instructions, Memory = {} bytes",
        pack_write_cpu, pack_write_mem
    );
    println!(
        "Savings: {:.2}% CPU, {:.2}% Memory",
    ...
    println!(
        "Separate storage slots: CPU = {} instructions, Memory = {} bytes",
        sep_read_cpu, sep_read_mem
    );
    println!(
        "Packed (bitwise) slot : CPU = {} instructions, Memory = {} bytes",
        pack_read_cpu, pack_read_mem
    );
    println!(
        "Savings: {:.2}% CPU, {:.2}% Memory",
    ...
    println!(
        "Separate storage slots: CPU = {} instructions, Memory = {} bytes",
        sep_update_cpu, sep_update_mem
    );
    println!(
        "Packed (bitwise) slot : CPU = {} instructions, Memory = {} bytes",
        pack_update_cpu, pack_update_mem
    );
    println!(
        "Savings: {:.2}% CPU, {:.2}% Memory",
...
fn test_bitmask_vs_map_benchmark() {
    ...
    println!(
        "Map storage    : CPU = {} instructions, Memory = {} bytes",
        map_write_cpu, map_write_mem
    );
    println!(
        "Bitmask storage: CPU = {} instructions, Memory = {} bytes",
        bitmask_write_cpu, bitmask_write_mem
    );
    println!(
        "Savings: {:.2}% CPU, {:.2}% Memory",
    ...
    println!(
        "Map storage    : CPU = {} instructions, Memory = {} bytes",
        map_read_cpu, map_read_mem
    );
    println!(
        "Bitmask storage: CPU = {} instructions, Memory = {} bytes",
        bitmask_read_cpu, bitmask_read_mem
    );
    println!(
        "Savings: {:.2}% CPU, {:.2}% Memory",
    ...
    println!(
        "Map storage    : CPU = {} instructions, Memory = {} bytes",
        map_update_cpu, map_update_mem
    );
    println!(
        "Bitmask storage: CPU = {} instructions, Memory = {} bytes",
        bitmask_update_cpu, bitmask_update_mem
    );
    println!(
        "Savings: {:.2}% CPU, {:.2}% Memory",
