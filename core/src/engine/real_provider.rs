...
use super::traits::{ProviderError, SimulationProvider, SimulationRpcResult};
use crate::rpc_throttle::RpcThrottle;
...
impl SimulationProvider for RealRpcProvider {
    async fn simulate_transaction(
        ...
        self.throttle.observe(response.headers()).await;
